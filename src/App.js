...
function App() {
  ...
  const [token, setToken] = useState('eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJmYXRtYTIiLCJpYXQiOjE3MTU1MzU2NTgsImV4cCI6MTcxNTYyMjA1OH0.RjujRX9ImQ8-CScx_S3u2wQiFlKY4ZWHBz9pexhbcOA');
