...
function App() {
  ...
  const [token, setToken] = useState('eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJmYXRtYTIiLCJpYXQiOjE3MTQ5Mzc2NDcsImV4cCI6MTcxNTAyNDA0N30.WStLsdVsJakWTQNjbik0tJUh_UduB2hPKvH6oln37v0');
